...
class BertConfig(object):
    ...
    def __init__(
        ...
        intermediate_size=4096,       #  4 x 768 = 3,072 concatenate the last four layers,
        hidden_act="gelu",
...
def transformer_model(
    ...
    num_hidden_layers=24,         #12
    num_attention_heads=16,       #12
    intermediate_size=4096,       #  4 x 768 = 3,072 , 4 x 1024=4096 
    intermediate_act_fn=gelu,     #concatenate the last four layers
    hidden_dropout_prob=0.1,
    attention_probs_dropout_prob=0.1,
    initializer_range=0.02,
